...
package org.apache.activemq.broker.registry.zookeeper;
...
import org.apache.activemq.broker.registry.exception.RegExceptionHandler;
 ...
 */
@Slf4j
public class ZookeeperRegistryCenter extends CoordinatorRegistryCenter {
    ...
    public void start() throws Exception {
        ...
        log.info("Zookeeper registry center started, server lists is: {}.", zkConfig.getServerLists());
    }
    ...
    public void stop() throws Exception {
        ...
        log.info("Zookeeper registry center stopped.");
    }
    ...
    public String getDirectly(final String key) {
        try {
            ...
            if (data != null) {
                s = new String(client.getData().forPath(key), Charsets.UTF_8);
            }
            return s;
            //CHECKSTYLE:OFF
        } catch (final Exception ex) {
    ...
    @Override
    public <T> T getDirectly(String key, Class<T> clazz) {
        String data = getDirectly(key);
        T t = null;
        if (StringUtils.isNotEmpty(data)) {
            t = JSON.parseObject(data, clazz);
        }
    ...
    public void addCacheData(String cachePath) {
        this.addCacheData(cachePath, null);
    }

    @Override
    public void addCacheData(final String cachePath, final CacheListenerCallback callback) {
                ...
                cache.getListenable().addListener(new TreeCacheListener() {
                    ...
                    public void childEvent(CuratorFramework curatorFramework, TreeCacheEvent treeCacheEvent) throws Exception {
                        switch (treeCacheEvent.getType()) {
                            ...
                            default:
                                log.debug("Event ignored: {}", treeCacheEvent);
                        }
                    }
                });
            }
